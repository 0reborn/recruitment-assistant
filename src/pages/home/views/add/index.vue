    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form>
            ...
            <div class="input-group mb-4">
              ...
              <input v-model="pushman" type="text" class="form-control" placeholder>
              <div class="input-group-prepend">
                <span class="input-group-text">内推码</span>
              </div>
              <input v-model="pushcode" type="text" class="form-control" placeholder>
            </div>
            ...
            <div class="collapse mb-4" id="addStatusArea">
              <div class="card card-body">
                <div class="input-group mb-4">
                  <div class="input-group-prepend">
                    <label class="input-group-text">应聘状态</label>
                  </div>
                  <select v-model="status.name" class="custom-select">
                    <option>宣讲会</option>
                    <option>面试</option>
                    <option>笔试</option>
                    <option>offer</option>
                  </select>
                  <select v-model="status.pos" class="custom-select">
                    <option>线下</option>
                    <option>线上</option>
                  </select>
                </div>
                ...
                <label>日期</label>
                <div class="input-group mb-4">
                  <el-date-picker v-model="status.time" type="datetime" placeholder="选择日期时间"></el-date-picker>
                </div>
            ...
            <div style="text-align: center" class="alert alert-primary" role="alert">热门应聘记录</div>

            <div v-for="(arr, index) in [[1,2], [3,4]]" :key="index" class="card-group">
              <div v-for="i in arr" :key="i" class="card">
                <div class="wrapper">
                  <img
                    class="card-img-top"
                    src="https://uploadfiles.nowcoder.com/files/20190308/999991354_1552030220194_%E6%8B%9B%E5%95%86.png"
                    alt="Card image cap"
                  >
                  <div class="card-body">
        ...
        <div class="modal-footer">
          <button @click="addRecord" type="button" class="btn btn-primary">添加</button>
